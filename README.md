...
- [Проверка валидации](tests/cases/2_check_point_validation) - проверяется корректность валидации значения точки *start*
  в команде *solve*.
- [Генерация лабиринта](tests/cases/3_check_maze_generation) - проверяется сохранение вырожденного лабиринта 1x1 в файл.
- [Решение лабиринта](tests/cases/4_check_maze_solving) - проверяется корректное решение заранее заданного лабиринта
  алгоритмом *A-star* и сохранение решения в файл.
